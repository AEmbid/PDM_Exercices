...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MiAdaptador adaptador = new MiAdaptador(datosLista,getApplicationContext());
    ...
    private ArrayList<Item> leerDatos() {
        ...
        for(int i=0; i<3; i++)
            datos.add(new Item(getResources().getStringArray(R.array.ciudades)[i]));
        return datos;
    }
